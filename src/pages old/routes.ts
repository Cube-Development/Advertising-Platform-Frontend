...
export const privateCommonRoutes: IRoute[] = [
  ...
  { path: paths.addLegal, component: AddProfilePage, sidebar: true },
];
...
export const privateBloggerRoutes: IRoute[] = [
  { path: paths.addChannel, component: AddPlatformPage, sidebar: true },
  { path: paths.myChannels, component: PlatformsPage, sidebar: true },
