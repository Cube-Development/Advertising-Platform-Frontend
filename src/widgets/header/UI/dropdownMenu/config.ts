...
export const advertiserMenu = [
    ...
    subItems: [
      ...
      {title: "orders_advertiser.type_filter.manager_project", path: paths.orders},
      {title: "orders_advertiser.type_filter.saved_project", path: paths.orders},
    ]},
    { item : {title: "burger_menu.template", path: paths.main, img: TemplateIcon}}
  ];
  
  export const bloggerMenu = [
    { item: {title: "burger_menu.platforms", path: paths.platforms, img: CampaignIcon}},
    { item: {title: "burger_menu.offers", path: paths.offers, img: TemplateIcon}},
  ];
