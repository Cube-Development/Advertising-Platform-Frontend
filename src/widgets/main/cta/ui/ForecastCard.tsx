  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[11px] uppercase tracking-[0.12em] font-bold text-[#0F2A4D]/50">
            {hasCategory
              ? t("main_advertiser.cta.forecast.titleWithCategory")
              : t("main_advertiser.cta.forecast.titleDefault")}
          </div>
          <div className="flex items-baseline gap-1.5">
            <span
              className={`inlinenline-flex relative overflow-visible text-[18px] sm:text-[22px] font-bold tabular-nums leading-tight transition-colors ${
      ...
      >
        <TrendingUp
          size={12}
          className={`transition-transform ${isPulsing ? "-translate-y-0.5" : ""}`}
        />
