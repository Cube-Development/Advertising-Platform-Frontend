...
/**
 * Хук для централизованного управления input-устройствами
 * Применяет DRY - вся логика управления устройствами в одном месте
 * Основан на референсной реализации из agent-starter-react
 */
