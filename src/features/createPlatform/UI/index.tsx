          ...
          <div className={styles.modal}>
            <div className={styles.modalContent}>
                ...
                <div className={styles.text}>
                    ...
                    <p>{t("add_platform.create.answer.text1")} <span>{t("add_platform.create.answer.span")}</span> {t("add_platform.create.answer.text2")}</p>
                </div>
                <MyButton className={styles.accept__btn} onClick={handleCloseModal}>{t("add_platform_btn.accept")}</MyButton>
            </div>
          </div>
        )}
      </div>
