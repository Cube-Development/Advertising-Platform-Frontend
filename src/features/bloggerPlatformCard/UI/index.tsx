        ...
        <div className={styles.card}>
            <div className={styles.card__top}>
                ...
                <div className={styles.channel__logo}>
                    ...
                    {
                        (card.status === platformStatus.active || card.status === platformStatus.deactivate)
                        ?
                        <RatingIcon />
                        :
                        <></>
                ...
                <div className={styles.card__description}>
                    <div>
                        ...
                        <div>
                            {
                                (card.status === platformStatus.reject || card.status === platformStatus.ban)
                                ?
                                <p>
                                    {card.date_event}
                                </p>
...

                        {
                            ...
                            <>
                                <p>
                                    ...
                                    <span className={card.offers !==  0 ? styles.offers_exist : ''}>
                                        {card.offers}
                                    </span>
                                </p>
                                <SeeOffersBtn />
            ...
            <div className={styles.platform_events}>
                <button>
                    <p>
                        {t(`platform_btn.description`)} 
                    </p>
                </button>
                <button>
                    <p>
                        {t(`platform_btn.calendar`)} 
                    </p>
                </button>
                <button>
                    <p>
                        {t(`platform_btn.reviews`)} 
                    </p>
                </button>
            </div>}
